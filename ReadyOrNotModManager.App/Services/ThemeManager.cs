...
public static class ThemeManager
{
    ...
    [
        ...
        new("red", "Red gradient", MediaColor.FromRgb(0x18, 0x07, 0x0A), MediaColor.FromRgb(0x3B, 0x0F, 0x15), MediaColor.FromRgb(0x1F, 0x0B, 0x0F), MediaColor.FromRgb(0x48, 0x13, 0x1A), MediaColor.FromRgb(0x27, 0x10, 0x14), MediaColor.FromRgb(0x4F, 0x19, 0x20), MediaColor.FromRgb(0x33, 0x14, 0x18), MediaColor.FromRgb(0x62, 0x20, 0x2A), MediaColor.FromRgb(0x76, 0x3C, 0x45), MediaColor.FromRgb(0xFF, 0xF0, 0xF2), MediaColor.FromRgb(0xD0, 0xA6, 0xAD), MediaColor.FromRgb(0xFF, 0x6F, 0x83), MediaColor.FromRgb(0x7B, 0xB6, 0xD8), MediaColor.FromRgb(0xFF, 0x4B, 0x5F), MediaColor.FromRgb(0x7E, 0xB3, 0x86)),
